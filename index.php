...
<html lang="en">
    ...
    <!-- Mirrored from preview.colorlib.com/theme/studylab/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Dec 2020 04:13:29 GMT -->
    <head>
        <title>Cleanview multi level marketing team consult</title>
        <meta charset="utf-8">
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
            <div class="container">
                <a class="navbar-brand" href="index.php"><span>Clean</span>view</a>
            ...
            <div class="container">
                <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
                    <div class="col-md-7 ftco-animate">
                        ...
                        <h1 class="mb-4 welcome_bckgr">Cleanview MLM Team Consult</h1>
                        <p class="caps welcome_intro">WE HELP OUR MEMBERS SEE THE POSSIBILITIES OF BECOMING FINANCIALLY STABLE WHICH, HELPS IN REGAINING CONFIDENCE</p>
                        <p class="mb-0"><a href="#" class="btn btn-primary">Learn More</a> <a href="#" class="btn btn-white">Benefits</a></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 order-md-last">
                        <div class="login-wrap p-4 p-md-5">
                            <h3 class="mb-4">Register To Join Our Team</h3>
                            <form action="#" class="signup-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="password-field1" type="password" class="form-control" placeholder="Password"><input type="checkbox" onclick="myRevealPasswordFunction()">Show Password
                                </div>
                                <div class="form-group">
